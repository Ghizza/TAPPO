...
APP_COLORS = {
    ...
    "text_light": "#d9d9d9",
    "border": "#666666",
    "link_01": "#0076d6", # 2973FF Morpho.org - 0076d6 Intel - 0672CB Dell
    "link_02": "#44d62c", # 44d62c Razer - 91c733 Nvidia
}
...
class TappoApp(ctk.CTk):
    ...
    def get_ui_styles(self):
        ...
        return {
            'label': {
                "font": (("Segoe UI", "Liberation Sans", "DejaVu Sans", "Helvetica", "Arial", "sans-serif"), 13, "bold"), 
                "text_color": APP_COLORS["text"]
            },
            'entry': {
                "width": 350, "font": (("Segoe UI", "Liberation Sans", "DejaVu Sans", "Helvetica", "Arial", "sans-serif"), 13),
            ...
            'button': {
                ...
                "font": (("Segoe UI", "Liberation Sans", "DejaVu Sans", "Helvetica", "Arial", "sans-serif"), 13, "bold"), "border_width": 1, 
    ...
    def add_input_row(self, row, label_text, variable, browse_command=None):
        ...
        if browse_command:
            ctk.CTkButton(self.main_frame, text="Sfoglia", command=browse_command, 
                         **styles['button']).grid(row=row, column=2, padx=(15, 0), pady=10)
    ...
    def show_main_content(self):
        ...
        ctk.CTkOptionMenu(
            ...
            width=350, font=(("Segoe UI", "Liberation Sans", "DejaVu Sans", "Helvetica", "Arial", "sans-serif"), 13), fg_color=APP_COLORS["dark"], 
        ...
        compress_button = ctk.CTkButton(
            ...
            fg_color=APP_COLORS["dark"], hover_color=APP_COLORS["hover"],
            text_color=APP_COLORS["link_02"], font=(("Segoe UI", "Liberation Sans", "DejaVu Sans", "Helvetica", "Arial", "sans-serif"), 13, "bold"),
    ...
    def create_side_menu(self):
        ...
        menu_button_style = {
            ...
            "font": (("Segoe UI", "Liberation Sans", "DejaVu Sans", "Helvetica", "Arial", "sans-serif"), 11, "bold"), "height": 24
        }
    ...
    def create_info_screen(self, title, content, buttons):
        ...
        title_label = ctk.CTkLabel(
            ...
            font=(("Segoe UI", "Liberation Sans", "DejaVu Sans", "Helvetica", "Arial", "sans-serif"), 16, "bold"),
        ...
        text_widget = ctk.CTkTextbox(
            ...
            font=(("Segoe UI", "Liberation Sans", "DejaVu Sans", "Helvetica", "Arial", "sans-serif"), 12),
...
• La compressione varia in base al contenuto del PDF"""
        ...
        button_style_primary = {
            "fg_color": APP_COLORS["dark"], "hover_color": APP_COLORS["hover"],
            "text_color": APP_COLORS["link_01"], "font": (("Segoe UI", "Liberation Sans", "DejaVu Sans", "Helvetica", "Arial", "sans-serif"), 13, "bold"),
        ...
        button_style_secondary = {
            "fg_color": APP_COLORS["dark"], "hover_color": APP_COLORS["hover"],
            "text_color": APP_COLORS["text"], "font": (("Segoe UI", "Liberation Sans", "DejaVu Sans", "Helvetica", "Arial", "sans-serif"), 13, "bold"),
...
• CustomTkinter Community"""
        ...
        button_style_primary = {
            "fg_color": APP_COLORS["dark"], "hover_color": APP_COLORS["hover"],
            "text_color": APP_COLORS["link_01"], "font": ("sans-serif", 13, "bold"),
            "corner_radius": APP_STYLE["corner_radius"], "border_width": 1,
            "border_color": APP_COLORS["link_01"], "width": 150
        }
        ...
        button_style_secondary = {
            "fg_color": APP_COLORS["dark"], "hover_color": APP_COLORS["hover"],
            "text_color": APP_COLORS["text"], "font": ("sans-serif", 13, "bold"),
            "corner_radius": APP_STYLE["corner_radius"], "border_width": APP_STYLE["border_width"],
            "border_color": APP_COLORS["border"], "width": 150
        }
