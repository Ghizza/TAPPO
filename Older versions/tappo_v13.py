...
"""
    ...
    def show_credits(self):
        ...
        info_frame = ctk.CTkFrame(self.main_frame, fg_color=APP_COLORS["dark"], corner_radius=10)
        info_frame.pack(pady=5, padx=10, fill="both", expand=True)

        ctk.CTkLabel(info_frame, text="Versione: 1.0", font=(APP_STYLE["font_family"], 13), text_color=APP_COLORS["text"]).pack(pady=(5, 2))
        ctk.CTkLabel(info_frame, text="Creato da: Stefano", font=(APP_STYLE["font_family"], 13), text_color=APP_COLORS["text"]).pack(pady=(2, 2))
        ctk.CTkLabel(info_frame, text="Licenza: MIT License", font=(APP_STYLE["font_family"], 13), text_color=APP_COLORS["text"]).pack(pady=(2, 2))
        ctk.CTkLabel(info_frame, text="Tecnologie: Python, CustomTkinter, Ghostscript", font=(APP_STYLE["font_family"], 13), text_color=APP_COLORS["text"]).pack(pady=(2, 5))
